(function e(t, n, r) {
                ...
                function() {
                    ...
                    _initPathRoot: function() {
                        this._pathRoot || (this._pathRoot = o.Path.prototype._createElement("svg"),
                            this._panes.overlayPane.appendChild(this._pathRoot), this.options.zoomAnimation && o.Browser.any3d ? (o.DomUtil.addClass(this._pathRoot, "leaflet-zoom-animated"), this.on({
    ...
    11: [function(require, module, exports) {
        ...
        module.exports = function(e, r) {
            r || (r = {});
            var t = {};
            return util.strict(e, "string"), -1 === e.indexOf("/") && (e = urlhelper("/geocode/" + e + "/{query}.json", r.accessToken)), t.getURL = function() {
                return e
            }, t.queryURL = function(e) {
                var r = !(isArray(e) || "string" == typeof e),
                    n = r ? e.query : e;
                if (isArray(n)) {
                    for (var u = [], i = 0; i < n.length; i++) u[i] = encodeURIComponent(n[i]);
                    n = u.join(";")
                } else n = encodeURIComponent(n);
                feedback.record({
                    geocoding: n
                });
                var o = L.Util.template(t.getURL(), {
                    query: n
                });
                if (r && e.proximity) {
                    var l = L.latLng(e.proximity);
                    o += "&proximity=" + l.lng + "," + l.lat
                }
                return o
                ...
                if (e.length && e[0].length) {
                    for (var i = 0, o = []; i < e.length; i++) o.push(n(e[i]));
                    u = o.join(";")
                } else u = n(e);
